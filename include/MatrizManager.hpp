...
class MatrizManager
{
    public:
        ...
        void RellenarProm(int ,double );//rellena los 0 de una columna con un valor especificado
        void ImprimirMatriz(Array2D<double>); //Se encarga de Imprimir la matriz R (se puede modificar para imprimir cualquier matriz)
        ...
        Array2D<double> getMatrizR();
        Array2D<double> getMatrizRprom();
    ...
    Array2D<double> MatrizRprom;//matriz lista para descomponer
